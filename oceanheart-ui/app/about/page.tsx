...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About Me - {config.appName}</title>
        <meta name="description" content="Learn more about the creator behind {config.appName} and our journey revolutionizing therapy." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://oceanheart.ai/about" />
      </Head>
      ...
      <main className="bg-base-100">
        ...
        <section className="bg-neutral text-neutral-content py-20 px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <a href="mailto:youremail@domain.com" className="btn btn-primary btn-wide">
              Contact Me
            </a>
          </div>
        </section>
