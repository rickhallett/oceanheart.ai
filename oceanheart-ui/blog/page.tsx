    ...
    <>
      <section className="text-center max-w-xl mx-auto mt-12 mb-24 md:mb-32">
        ...
        <p className="text-lg opacity-80 leading-relaxed">
          Here you can find feature releases, roadmap updates, community survey research, a breadcrumb trail of the latest developments at the intersection of AI and therapy.
        </p>
      </section>
